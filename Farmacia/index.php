...
<body id="">
    ...
    <div class="jumbotron" id="jumbotron-index">
      <h1><center><span class="tittles-pages-logo">Farmacia Online</span> <small style="color: #fff;">EL SALVADOR</small></center></h1>
      <center>
      <p>
          Bienvenido a nuestra Farmacia en linea, donde encontraras productos a bajo precio.
      </p>
    </center>
    </div>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 text-center">
                   <article style="margin-top:20%;">
                        ...
                        <h3>Registrate</h3>
                        <p>Registrese y hagase cliente de <span class="tittles-pages-logo">Farmacia Online</span> para recibir las mejores ofertas y descuentos especiales de nuestros productos.</p>
                        <p><a href="registration.php" class="btn btn-info btn-block">Registrarse</a></p>   
                   </article>
                </div>
                <div class="col-xs-12 col-sm-6">
                    <img src="assets/img/LOGO ORIG.png" alt="Smart-TV" class="img-responsive">
                </div>
            </div>
        </div>
    </section>
    <section id="distribuidores-index">
        <div class="container">
            ...
            <div class="col-xs-12">
                ...
                <br><br>
                <img src="assets/img/productos-nov.png" alt="logos-marcas" class="img-responsive">
            </div>
        </div>
    </section>
