    ...
    <section id="prove-product-cat-config">
        <div class="container">
            <div class="page-header">
              <h1>Panel de administración <small class="tittles-pages-logo">Farmacia Online</small></h1>
            </div>
            <!-- Nav tabs -->
                        ...
                        <div id="add-product">
                            ...
                            <form role="form" action="process/regproduct.php" method="post" enctype="multipart/form-data">
                              ...
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control"  placeholder="Fecha" required maxlength="30" name="prod-model">
                              </div>
                              <div class="form-group">
                                <label>Fecha de Vencimiento</label>
                                <input type="text" class="form-control"  placeholder="Fecha" required maxlength="30" name="prod-marca">
                              </div>
                              <div class="form-group">
