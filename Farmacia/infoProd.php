        ...
        <div class="container">
            <div class="row">
                <div class="page-header">
                    <h1>Tienda <small class="tittles-pages-logo">Farmacia Online</small></h1>
                </div>
                <?php 
                    ...
                    while($fila=mysql_fetch_array($productoinfo)){
                        echo '
                            <div class="col-xs-12 col-sm-6">
                                ...
                                <h4><strong>Fecha Expedición: </strong>'.$fila['Modelo'].'</h4><br>
                                <h4><strong>Fecha Vencimiento: </strong>'.$fila['Marca'].'</h4><br>
