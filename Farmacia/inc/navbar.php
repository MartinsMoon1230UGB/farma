...
<nav id="navbar-auto-hidden">
        <div class="row hidden-xs"><!-- Menu  -->
            <div class="col-xs-4">
                <figure class=""></figure>
                <p class="text-navbar tittles-pages-logo"><img src="assets/img/logo-este.png" width="59px" height="59px" />Farmacia Online</p>
            </div>
            <div class="col-xs-8">
      ...
      <div class="modal-dialog modal-sm">
          <div class="modal-content" id="modal-form-login">
                <div class="modal-header">
                  ...
                  <h4 class="modal-title text-center text-primary" id="myModalLabel">Iniciar sesión en Farmacia Online</h4>
                </div>
    ...
    <div id="mobile-menu-list" class="hidden-sm hidden-md hidden-lg">
        <br>
        <h3 class="text-center tittles-pages-logo">Farmacia Online</h3>
